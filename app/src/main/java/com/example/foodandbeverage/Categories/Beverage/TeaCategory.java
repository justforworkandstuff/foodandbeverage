...
public class TeaCategory extends AppCompatActivity {

    RecyclerView teaView;
    List<RecipeData> teaRecipeList;
    ProgressDialog progressDialog;
    EditText search_Feature;
    RecipeAdapter teaAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teaRecipeList = new ArrayList<>();

        //initialization
        search_Feature = findViewById(R.id.tea_searchFeature);
        teaView = findViewById(R.id.tea_recyclerView);

        //assigning view with layout manager
        GridLayoutManager gridLayoutManager = new GridLayoutManager(TeaCategory.this, 1);
        teaView.setLayoutManager(gridLayoutManager);

        progressDialog = new ProgressDialog(this);
        progressDialog.setMessage("Loading recipes..");

        teaAdapter = new RecipeAdapter(TeaCategory.this, teaRecipeList);
        teaView.setAdapter(teaAdapter);

        //connecting to database named "Tea"-
        databaseReference = FirebaseDatabase.getInstance().getReference("Tea");
    ...
    private void filter(String text)
    {
        ...
        for(RecipeData item: teaRecipeList)
        {
        ...
        teaAdapter.categoryFilteredList(filterList);
    }

    public void tea_upload(View view)
    {
